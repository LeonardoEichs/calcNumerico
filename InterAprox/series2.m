...
% -0.055555555555556 t^2+0.342592592592593 t+0.405465108108165
coef = [-0.055555555555556  0.342592592592593 0.405465108108165];
sChebyschev = fserieCheby(tPlot, n-1, coef);
% Calculo do valor exato
valorExato = log(xPlot);
...
erroSerieChebyschev  = abs(sChebyschev - valorExato);
 plot( xPlot, erroInterpolador, "k;'Erro Interpolador';", xPlot, erroSerieTaylor, "b;'Erro Taylor';", xPlot, erroSerieChebyschev, "r;'Erro Serie Chebyschev';")
%plot( xPlot ,valorExato , "r;'Valor Exato';", xPlot , ygregorynewton, "k;'GregoryNewton';",xPlot , sTaylor, "b;'Serie Taylor';", 2.2,0.7)
